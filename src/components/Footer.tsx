        ...
        <div className="col-span-1 md:ml-auto">
          ...
          <div className="flex gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 border border-outline-variant/30 rounded-full flex items-center justify-center hover:border-primary transition-colors text-on-surface hover:text-primary"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
